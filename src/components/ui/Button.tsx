const Button = ({ children, ...args }: IButton) => {
  return (
    <button
      {...args}
      className='group relative inline-block overflow-hidden rounded border border-gray-100 bg-gray-200  px-12 py-3 md:px-6 md:py-1 text-sm font-medium text-slate-800 hover:text-gray-800 focus:outline-none focus:ring active:bg-gray-800 active:text-white'
    >
